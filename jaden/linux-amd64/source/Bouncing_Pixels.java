/* autogenerated by Processing revision 1292 on 2023-07-21 */
...
public void draw(){
  ...
  if (c.available() > 0) {
    ...
    myMouseX = PApplet.parseInt(map(PApplet.parseInt(x),0,640,0,displayWidth));
    myMouseY = PApplet.parseInt(map(PApplet.parseInt(y),0,480,0,displayHeight));
  }
...
public void checktime(){
  ...
  if(PApplet.parseInt(frameCount/frameRate) == 30){
